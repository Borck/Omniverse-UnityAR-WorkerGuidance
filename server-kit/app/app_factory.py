...
from app.assets.draco import DracoCodec, DracoCodecConfig
from app.guidance.export_job_service import ExportJobService
from app.guidance.export_pipeline import StepPackageExporter
from app.core.logging import configure_logging
from app.omniverse.stage_service import StageOpenService
from app.omniverse.resolver import LayerStackResolver
from app.guidance.manifest_service import ManifestService
from app.guidance.repository import StepDefinitionRepository
from app.guidance.session import SessionManager, SessionState
      ...
      "resolvedSteps": [
        {
          ...
          "keep_visible_until_step": item.keep_visible_until_step,
          "handover_target_layer_id": item.handover_target_layer_id,
          "handover_next_animation_layer_id": item.handover_next_animation_layer_id,
          "visible_layer_ids": list(item.visible_layer_ids),
          "muted_layer_ids": list(item.muted_layer_ids),
